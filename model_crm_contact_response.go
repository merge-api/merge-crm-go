...
// CRMContactResponse struct for CRMContactResponse
...
func (o CRMContactResponse) MarshalJSON() ([]byte, error) {
...
func (v *CRMContactResponse) UnmarshalJSON(src []byte) error {
    type CRMContactResponseUnmarshalTarget CRMContactResponse

	var intermediateResult CRMContactResponseUnmarshalTarget
	...
	*v = CRMContactResponse(intermediateResult)
	return nil
}
type NullableCRMContactResponse struct {
	value *CRMContactResponse
	isSet bool
}

func (v NullableCRMContactResponse) Get() *CRMContactResponse {
	return v.value
}

func (v *NullableCRMContactResponse) Set(val *CRMContactResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCRMContactResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCRMContactResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCRMContactResponse(val *CRMContactResponse) *NullableCRMContactResponse {
	return &NullableCRMContactResponse{value: val, isSet: true}
}

func (v NullableCRMContactResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCRMContactResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
