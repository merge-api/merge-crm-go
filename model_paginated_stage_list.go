...
func (o *PaginatedStageList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedStageList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []Stage and assigns it to the Results field.
...
func (v *PaginatedStageList) UnmarshalJSON(src []byte) error {
    type PaginatedStageListUnmarshalTarget PaginatedStageList

	var intermediateResult PaginatedStageListUnmarshalTarget
	...
	*v = PaginatedStageList(intermediateResult)
	return nil
}
