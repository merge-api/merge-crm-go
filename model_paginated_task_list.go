...
func (o *PaginatedTaskList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedTaskList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (v *PaginatedTaskList) UnmarshalJSON(src []byte) error {
    type PaginatedTaskListUnmarshalTarget PaginatedTaskList

	var intermediateResult PaginatedTaskListUnmarshalTarget
	...
	*v = PaginatedTaskList(intermediateResult)
	return nil
}
