...
type AccountDetailsApiService service
...
/*
 * AccountDetailsRetrieve Method for AccountDetailsRetrieve
 * Get details for a linked account.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiAccountDetailsRetrieveRequest
 */
func (a *AccountDetailsApiService) AccountDetailsRetrieve(ctx _context.Context) ApiAccountDetailsRetrieveRequest {
	return ApiAccountDetailsRetrieveRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *AccountDetailsApiService) AccountDetailsRetrieveExecute(r ApiAccountDetailsRetrieveRequest) (AccountDetails, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountDetailsApiService.AccountDetailsRetrieve")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/account-details"
