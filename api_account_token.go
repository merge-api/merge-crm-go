...
type AccountTokenApiService service

type ApiAccountTokenRetrieveRequest struct {
	ctx _context.Context
	ApiService *AccountTokenApiService
	publicToken string
}
...
/*
 * AccountTokenRetrieve Method for AccountTokenRetrieve
 * Returns the account token for the end user with the provided public token.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param publicToken
 * @return ApiAccountTokenRetrieveRequest
 */
func (a *AccountTokenApiService) AccountTokenRetrieve(ctx _context.Context, publicToken string) ApiAccountTokenRetrieveRequest {
	return ApiAccountTokenRetrieveRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *AccountTokenApiService) AccountTokenRetrieveExecute(r ApiAccountTokenRetrieveRequest) (AccountToken, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"public_token"+"}", _neturl.PathEscape(parameterToString(r.publicToken, "")), -1)
